...
public class HODApproveHandler : IRequestHandler<HODApproveCommand, ApiResponse<bool>>
{
    private readonly AppDbContext _db;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public HODApproveHandler(AppDbContext db, IHttpContextAccessor httpContextAccessor)
    {
        _db = db;
        _httpContextAccessor = httpContextAccessor;
    }

    public async Task<ApiResponse<bool>> Handle(HODApproveCommand request, CancellationToken cancellationToken)
    {
        ...
        if (accessRequest.Status != AccessStatus.PendingHOD) return ApiResponse<bool>.Fail("Invalid status");

        accessRequest.Status = AccessStatus.PendingIT;
        ...
        _db.AccessApprovals.Add(new AccessApproval
        {
            ...
            EmpId = empId,
            TypeOfAccessApproval = ApprovalType.HOD,
        ...
        _db.AuditLogs.Add(new AuditLogEntity
        {
            ...
            Actor = empId,
            Action = AuditAction.HODApproved,
