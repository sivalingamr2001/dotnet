...
public class HODRejectHandler : IRequestHandler<HODRejectCommand, ApiResponse<bool>>
{
    private readonly AppDbContext _db;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public HODRejectHandler(AppDbContext db, IHttpContextAccessor httpContextAccessor)
    {
        _db = db;
        _httpContextAccessor = httpContextAccessor;
    }

    public async Task<ApiResponse<bool>> Handle(HODRejectCommand request, CancellationToken cancellationToken)
    {
        ...
        _db.AuditLogs.Add(new AuditLogEntity
        {
            ...
            Actor = empId,
            Action = AuditAction.HODRejected,
